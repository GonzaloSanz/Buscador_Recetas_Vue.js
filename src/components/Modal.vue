                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mt-3">
                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold mt-2 mb-5">
                                    ...
                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold mt-8 mb-5">
                            ...
                            <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                                <button type="button"
                                    class="w-full rounded bg-orange-600 hover:bg-orange-700 transition-colors p-3 font-bold uppercase text-white shadow"
                                    @click="favoritos.handleClickFavorito()">
                                    {{ modal.textoBoton }}
                                </button>

                                <button type="button"
                                    class="w-full rounded bg-gray-600 hover:bg-gray-700 transition-colors p-3 font-bold uppercase text-white shadow"
